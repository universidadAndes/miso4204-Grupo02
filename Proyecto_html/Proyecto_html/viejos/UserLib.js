$(function() {
    ...
    $("body").one("pinegrow-ready", function(e, pinegrow) {
        ...
        var comp_comp1 = new PgComponentType('comp1', 'Comp 1 / h2');
        comp_comp1.code = '<h2 class="featurette-heading crsa-selected">First featurette heading. <span class="text-muted">It\'ll blow your mind.</span></h2>';
